...
interface RequestAPI {
    ...
    suspend fun makeMarketLatestListCall(
        ...
        @Query("aux") aux: String = "ath,atl,high24h,low24h,num_market_pairs,cmc_rank,date_added,max_supply,circulating_supply,total_supply,volume_7d,volume_30d,self_reported_circulating_supply,self_reported_market"
